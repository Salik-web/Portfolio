...
export default function MemePortfolio() {
  ...
  return (
    ...
    {/* floating FAHHH — kept OUTSIDE the root div on purpose. DEEP FRY puts a
        CSS filter on the root, and a filter on an ancestor re-anchors
        position:fixed children to it (so the button would jump off-screen).
        As a sibling of the root, it stays pinned to the viewport during fry. */}
    <div
